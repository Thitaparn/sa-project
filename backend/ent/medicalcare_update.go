...
func (mcu *MedicalCareUpdate) SetMedicalcareName(s string) *MedicalCareUpdate {
	mcu.mutation.SetMedicalcareName(s)
	return mcu
}
...
func (mcu *MedicalCareUpdate) Save(ctx context.Context) (int, error) {
	if v, ok := mcu.mutation.MedicalcareName(); ok {
		if err := medicalcare.MedicalcareNameValidator(v); err != nil {
			return 0, &ValidationError{Name: "medicalcare_name", err: fmt.Errorf("ent: validator failed for field \"medicalcare_name\": %w", err)}
		}
	}
...
func (mcu *MedicalCareUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mcu.mutation.MedicalcareName(); ok {
...
// SetMedicalcareName sets the medicalcare_name field.
func (mcuo *MedicalCareUpdateOne) SetMedicalcareName(s string) *MedicalCareUpdateOne {
	mcuo.mutation.SetMedicalcareName(s)
	return mcuo
}
...
func (mcuo *MedicalCareUpdateOne) Save(ctx context.Context) (*MedicalCare, error) {
	if v, ok := mcuo.mutation.MedicalcareName(); ok {
		if err := medicalcare.MedicalcareNameValidator(v); err != nil {
...
func (mcuo *MedicalCareUpdateOne) sqlSave(ctx context.Context) (mc *MedicalCare, err error) {
	...
	if value, ok := mcuo.mutation.MedicalcareName(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: medicalcare.FieldMedicalcareName,
