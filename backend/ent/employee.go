...
func (e EmployeeEdges) PatientsOrErr() ([]*Patient, error) {
	if e.loadedTypes[0] {
...
// QueryPatients queries the patients edge of the Employee.
func (e *Employee) QueryPatients() *PatientQuery {
	return (&EmployeeClient{config: e.config}).QueryPatients(e)
}
