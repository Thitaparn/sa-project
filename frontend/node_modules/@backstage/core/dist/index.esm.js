import privateExports__default, { createApiFactory, discoveryApiRef, configApiRef, UrlPatternDiscovery, alertApiRef, AlertApiForwarder, errorApiRef, ErrorAlerter, ErrorApiForwarder, storageApiRef, WebStorage, featureFlagsApiRef, FeatureFlags, oauthRequestApiRef, OAuthRequestManager, googleAuthApiRef, GoogleAuth, microsoftAuthApiRef, MicrosoftAuth, githubAuthApiRef, GithubAuth, oktaAuthApiRef, OktaAuth, gitlabAuthApiRef, GitlabAuth, auth0AuthApiRef, Auth0Auth, oauth2ApiRef, OAuth2, samlAuthApiRef, SamlAuth, defaultSystemIcons, useApi, useApiHolder } from '@backstage/core-api';
...
import { makeStyles, Grid, Typography, Link as Link$1, LinearProgress, Snackbar, IconButton, Button as Button$1, Tooltip, useTheme, ClickAwayListener, ListItem, ListItemAvatar, ListItemText, Dialog, DialogTitle, DialogContent, List, DialogActions, Divider, ListItemIcon, withStyles, CardActions, Card, CardHeader, CardContent, Stepper, Step, StepLabel, StepContent, TableCell, createStyles, Table as Table$1, TableBody, TableRow, Popover, SvgIcon, InputBase, FormControl, Select, Chip, MenuItem, Checkbox, Collapse, Tab, Tabs as Tabs$1, AppBar, Breadcrumbs, Badge, TextField, styled, FormHelperText } from '@material-ui/core';
...
import missingAnnotation2 from './components/EmptyState/assets/missingAnnotation.svg';
import noInformation2 from './components/EmptyState/assets/noInformation.svg';
import createComponent2 from './components/EmptyState/assets/createComponent.svg';
import noBuild2 from './components/EmptyState/assets/noBuild.svg';
...
const defaultApis = [
  ...
  createApiFactory({
    ...
    factory: ({discoveryApi, oauthRequestApi}) => GoogleAuth.create({discoveryApi, oauthRequestApi})
  }),
  createApiFactory({
    ...
    factory: ({discoveryApi, oauthRequestApi}) => MicrosoftAuth.create({discoveryApi, oauthRequestApi})
  }),
  createApiFactory({
    ...
    factory: ({discoveryApi, oauthRequestApi}) => GithubAuth.create({discoveryApi, oauthRequestApi})
  }),
  createApiFactory({
    api: oktaAuthApiRef,
    deps: {
    ...
    factory: ({discoveryApi, oauthRequestApi}) => OktaAuth.create({discoveryApi, oauthRequestApi})
  }),
  createApiFactory({
    ...
    factory: ({discoveryApi, oauthRequestApi}) => GitlabAuth.create({discoveryApi, oauthRequestApi})
  }),
  createApiFactory({
    api: auth0AuthApiRef,
    deps: {
    ...
    factory: ({discoveryApi, oauthRequestApi}) => Auth0Auth.create({discoveryApi, oauthRequestApi})
  }),
  createApiFactory({
    api: oauth2ApiRef,
    deps: {
    ...
    factory: ({discoveryApi, oauthRequestApi}) => OAuth2.create({discoveryApi, oauthRequestApi})
  }),
  createApiFactory({
    api: samlAuthApiRef,
    deps: {
...
const CodeSnippet = ({
  ...
  const highlightColor = theme2.palette.type === "dark" ? "#256bf3" : "#e6ffed";
  return /* @__PURE__ */ React.createElement("div", {
    ...
    showLineNumbers,
    wrapLines: true,
    lineNumberStyle: {color: theme2.palette.textVerySubtle},
...
const useStyles$3 = makeStyles((theme2) => ({
  root: {
    ...
    marginBottom: theme2.spacing(0),
    marginTop: theme2.spacing(0),
    display: "flex",
    flexFlow: "row nowrap"
  },
  topPosition: {
  ...
  message: {
    display: "flex",
    alignItems: "center",
    color: theme2.palette.banner.text,
    "& a": {
      color: theme2.palette.banner.link
    }
  },
  info: {
...
const InfoCard = ({
  ...
  return /* @__PURE__ */ React.createElement(Card, {
    ...
    slackChannel
  }, title && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(CardHeader, {
    classes: {
      root: classes.header,
...
const useStyles$g = makeStyles(() => createStyles({
  icon: {
    position: "absolute",
    right: "4px",
    pointerEvents: "none"
...
const useStyles$h = makeStyles(() => createStyles({
  icon: {
    position: "absolute",
    right: "4px",
    pointerEvents: "none"
...
const SelectComponent = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    renderValue: (selected) => {
      ...
      })) : /* @__PURE__ */ React.createElement(Typography, null, value.length === 0 ? placeholder || "" : (_a = items.find((el) => el.value === selected)) == null ? void 0 : _a.label);
    },
    IconComponent: () => !canOpen ? /* @__PURE__ */ React.createElement(ClosedDropdown, null) : /* @__PURE__ */ React.createElement(OpenedDropdown, null),
    MenuProps: {
      anchorOrigin: {
        vertical: "bottom",
        horizontal: "left"
...
const useStyles$j = makeStyles$1((theme) => createStyles$1({
  root: {
    width: "100%",
    minWidth: 10,
    maxWidth: 360,
...
const CheckboxTree = (props) => {
  ...
  useEffect(() => {
    const values = Object.values(state).map((category) => ({
      ...
      selectedChilds: Object.values(category.options).filter((option) => option.isChecked).map((option) => option.value)
    }));
    onChange(values);
  }, [state]);
  useEffect(() => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Typography, {
    variant: "button"
  }, props.label), /* @__PURE__ */ React.createElement(List, {
    className: classes.root
    ...
    className: classes.text,
    primary: item.label
  }), Object.values(item.options).length ? /* @__PURE__ */ React.createElement(React.Fragment, null, item.isOpen ? /* @__PURE__ */ React.createElement(ExpandLess2, {
    "data-testid": "expandable",
    onClick: (event) => handleOpen(event, item.label)
  }) : /* @__PURE__ */ React.createElement(ExpandMore2, {
    "data-testid": "expandable",
    onClick: (event) => handleOpen(event, item.label)
...
const useSubvalueCellStyles = makeStyles((theme2) => ({
  ...
  header: {
    ...
    borderBottom: `1px solid ${theme2.palette.grey[500]}`
  },
  filters: {
    display: "flex",
    flexDirection: "column",
...
const Filters = (props) => {
  ...
  }, (filters == null ? void 0 : filters.length) && filters.map((filter) => filter.type === "checkbox-tree" ? /* @__PURE__ */ React.createElement(CheckboxTree, {
    triggerReset: reset,
    key: filter.element.label,
    ...filter.element,
    onChange: (el) => setSelectedFilters({
      ...selectedFilters,
      [filter.element.label]: el.filter((checkboxFilter) => checkboxFilter.category !== null || checkboxFilter.selectedChilds.length).map((checkboxFilter) => checkboxFilter.category !== null ? [
        ...checkboxFilter.selectedChilds,
        checkboxFilter.category
      ] : checkboxFilter.selectedChilds).flat()
    })
...
function Table({
  ...
  useEffect(() => {
    ...
    if (selectedFiltersArray.flat().length) {
      const newData = data.filter((el) => !!Object.entries(selectedFilters).filter(([, value]) => !!value.length).every(([key, value]) => {
        if (Array.isArray(value)) {
  ...
  const constructFilters = (filterConfig, dataValue) => {
    const extractColumnData = (column) => dataValue.map((el) => ({label: el[column], options: []}));
    return filterConfig.map((filter) => ({
      type: filter.type,
      element: filter.type === "checkbox-tree" ? {
        label: filter.column,
        subCategories: extractColumnData(getFieldByTitle(filter.column) || "")
      } : {
  ...
  return /* @__PURE__ */ React.createElement("div", {
  ...
  }, filtersOpen && (filters == null ? void 0 : filters.length) && /* @__PURE__ */ React.createElement(Filters, {
    ...
    components: {
      ...
      Toolbar: (toolbarProps) => (filters == null ? void 0 : filters.length) ? /* @__PURE__ */ React.createElement("div", {
      ...
      }, /* @__PURE__ */ React.createElement(FilterList2, null)), /* @__PURE__ */ React.createElement(Typography, {
        className: filtersClasses.title
      }, "Filters (", selectedFiltersLength, ")")), /* @__PURE__ */ React.createElement(MTableToolbar, {
        classes: toolbarClasses,
        ...toolbarProps
      })) : /* @__PURE__ */ React.createElement(MTableToolbar, {
        classes: toolbarClasses,
        ...toolbarProps
      })
    },
...
const useSubvalueCellStyles$1 = makeStyles((theme2) => ({
  value: {
    marginBottom: "6px"
  },
  subvalue: {
...
const useStyles$l = makeStyles((theme2) => ({
  root: {
    textTransform: "none",
    height: "64px",
    fontWeight: theme2.typography.fontWeightBold,
...
const useStyles$m = makeStyles((theme2) => ({
  indicator: {
    display: "flex",
...
const useStyles$n = makeStyles$1((theme2) => ({
  root: {
    flexGrow: 1,
    width: "100%"
  },
...
const WarningPanel = (props) => {
  const classes = useStyles$o(props);
...
const useStyles$r = makeStyles((theme2) => ({
  code: {
    borderRadius: 6,
    margin: `${theme2.spacing(2)}px 0px`,
    background: theme2.palette.type === "dark" ? "#444" : "#fff"
  }
}));
...
const useStyles$t = (props) => makeStyles((theme) => ({
  container: {
    width: "100%",
    display: "flex",
    flexDirection: "row",
...
const ContentHeader = ({
  ...
  const classes = useStyles$t({textAlign})();
...
const useStyles$v = makeStyles((theme2) => ({
  ...
  breadcrumbType: {
    fontSize: "inherit",
    opacity: 0.7,
    marginRight: -theme2.spacing(0.3),
    marginBottom: theme2.spacing(0.3)
  },
  breadcrumbTitle: {
    fontSize: "inherit",
    marginLeft: -theme2.spacing(0.3),
    marginBottom: theme2.spacing(0.3)
  }
}));
const TypeFragment = ({
  ...
  return /* @__PURE__ */ React.createElement(Breadcrumbs, {
    ...
    separator: /* @__PURE__ */ React.createElement(ChevronRight2, {
      fontSize: "small"
    }),
    ...
    className: classes.breadcrumbType
...
const Header = ({
  ...
  const classes = useStyles$v({backgroundImage: theme2.backgroundImage});
...
const SidebarPage = (props) => {
  ...
  const classes = useStyles$z({isPinned});
...
const Component$2 = ({onResult}) => {
  ...
  return /* @__PURE__ */ React.createElement(GridItem, null, /* @__PURE__ */ React.createElement(InfoCard, {
    ...
    variant: "outlined",
    className: classes.button,
    disabled: !(formState == null ? void 0 : formState.isDirty) || !isEmpty2(errors)
  }, "Continue"))));
};
